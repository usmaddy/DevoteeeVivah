(() => {
  const members = [
    ...
    // },
    {
      img: "../Resources/Images/Developer/Saideep_Prabhuji.jpg",
      alt: "Portrait of Saideep Pramanick, Developer",
      name: "Saideep Pramanick",
      role: "Graphic Designer",
    },
    {
      img: "../Resources/Images/Developer/manishprabhuji.jpg",
      alt: "Portrait of Manish Prabhu, Developer",
      name: "Manish Prabhuji",
      role: "Software Developer",
    },
    {
      img: "../Resources/Images/Developer/upeksh.jpg",
      alt: "Portrait of Upeksh Naik, Graphic Designer",
      name: "Upeksh Naik",
      role: "Web Developer",
    },
  ...
  const mainbackground = document.getElementById("background_team_section");
  const mainroles = document.getElementById("main-member-name-role");
  ...
  function updateMain(index) {
    ...
    mainbackground.style.backgroundImage = `url(${member.img})`;
