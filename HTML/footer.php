...
<body>
    <section class="footer">
        ...
        <div class="download_platforms">
            <a href="./iphone.php" class="app_for_ios_link">
            ...
            <a href="https://play.google.com/store/apps/details?id=net.manish.devotee_match&hl=en_IN" class="app_for_android_link">
                <div class="app_for_android">
                    <i class="fa-brands fa-android an"></i>
                    <h1 class="android_h1">Download App for Android</h1>
                </div>
            </a>
        </div>
